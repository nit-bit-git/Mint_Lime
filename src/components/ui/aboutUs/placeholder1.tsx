...
export function MintLimeIllustration() {
  return (
    <div className="border border-black/[0.2] dark:border-white/[0.2] flex flex-col items-start justify-between max-w-fit mx-auto relative min-h-[25rem] min-w-[20rem]">
      ...
      <span className="absolute w-full bottom-0 bg-slate-900/60 px-5 rounded-t-xl">
